...
exports.isScrollEnabled = exports.setScrollEnabled = exports.scrollChat = void 0;
...
const scrollChat = async (direction, amount) => {
...
Write-Host "[Scroll] Scroll operation completed"
    `.trim();
        const scriptPath = (0, path_1.join)((0, os_1.tmpdir)(), `scroll_${Date.now()}.ps1`);
        log('Script path', scriptPath);
        try {
            // Write PowerShell script to temp file
            (0, fs_1.writeFileSync)(scriptPath, psScript, 'utf8');
...
exports.isScrollEnabled = isScrollEnabled;
